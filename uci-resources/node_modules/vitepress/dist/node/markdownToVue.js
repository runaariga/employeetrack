...
function createMarkdownToVueRenderFn(srcDir, options = {}, pages, userDefines, isBuild = false) {
    ...
    return (src, file, publicDir) => {
        ...
        src = src.replace(includesRE, (_, m1) => {
            const includePath = path_1.default.join(dir, m1);
            console.log(includePath);
            const content = fs_1.default.readFileSync(includePath, 'utf-8');
            includes.push(slash_1.slash(includePath));
            return content;
        });
