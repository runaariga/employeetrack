...
function createVitePressPlugin(root, siteConfig, ssr = false, pageToHashMap, clientJSMap) {
    const { srcDir, configPath, alias, markdown, site, vue: userVuePluginOptions, vite: userViteConfig, pages } = siteConfig;
    let markdownToVue;
